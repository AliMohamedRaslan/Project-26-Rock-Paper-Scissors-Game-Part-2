...
print ("""Welcome to my twenty-sixth project (I'm Ali Mohamed Raslan)


	    ****  Welcome to the multiplication table ****


Explanation of this program in the following link on YouTube:
https://youtu.be/lgwl6sZxpg0
""")
...
while 0==0:
  ...
  if result == 13 or result == 21 or result == 32:
    ...
    streak=0
    cpscore+=1
  next = input("\n\nComputer Score: " +str(cpscore)+ "     Your Score: " +str(pscore)+ "\n\nStreak: " +str(streak)+ "             Highest Streak: " +str(highestStreak)+ "\n\nPress [ENTER] to play again,Or write (no) to exit this game  ").lower()
  if next == "no":
	  break

print ( "game over\nThank you very much for using this game.\n\nWith regards: Ali Mohamed Raslan " )
